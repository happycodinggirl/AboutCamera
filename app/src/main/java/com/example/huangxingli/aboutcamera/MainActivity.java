...
public class MainActivity extends BaseActivity implements View.OnClickListener, CameraView.OnSurfaceInfo {
    ...
    protected void onPause() {
        super.onPause();
        int childCount = preview.getChildCount();
        //removeView�ὫsurfaceView���٣���ȥ����onSurfaceDestroyed�������÷����ͷ���camera��������onResumeʱ���´�
        //�����
        if (childCount > 0) {
    ...
    public class MyPreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data1, Camera camera) {
            ...
            YuvImage yuv1 = new YuvImage(data, parameters.getPreviewFormat(), height, width, null);//!!!!!!!!!!!!注意此处一定要宽高互换否则会有多个

            ByteArrayOutputStream out = new ByteArrayOutputStream();
            yuv1.compressToJpeg(new Rect(0, 0, height, width), 50, out);//!!!!!!!!!!!!注意此处一定要宽高互换否则会有多个
